...
Write-Utf8NoBom "$root\src\app\taleplerim\page.tsx" $page

Write-Host ""
Write-Host "Taleplerim sayfasina puanlama ve yorum sistemi eklendi." -ForegroundColor Green
Write-Host ""
Write-Host "Eklenenler:" -ForegroundColor Cyan
Write-Host "  Sonuclanmis talepte 1-5 yildiz"
Write-Host "  Yorum alani"
Write-Host "  Degerlendirmeyi Gonder butonu"
Write-Host "  Daha once yorum varsa mevcut degerlendirme gorunumu"
