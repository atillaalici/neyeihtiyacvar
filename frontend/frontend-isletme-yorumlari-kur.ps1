...
Write-Utf8NoBom "$root\src\app\isletme\[slug]\page.tsx" $page

Write-Host ""
Write-Host "Isletme profilinde puan ve yorumlar hazirlandi." -ForegroundColor Green
Write-Host ""
Write-Host "Eklenenler:" -ForegroundColor Cyan
Write-Host "  Ortalama puan"
Write-Host "  Toplam degerlendirme sayisi"
Write-Host "  Yildiz gorunumu"
Write-Host "  Musteri yorumlari"
Write-Host "  Yorum yapan kullanici adi"
Write-Host "  Degerlendirme tarihi"
Write-Host "  Turkce karakter duzeltmeleri"
Write-Host ""
