...
Write-Utf8NoBom "$root\src\app\panel\page.tsx" $page

Write-Host ""
Write-Host "Isletme paneline degerlendirme bolumu eklendi." -ForegroundColor Green
Write-Host ""
Write-Host "Eklenenler:" -ForegroundColor Cyan
Write-Host "  Ortalama puan karti"
Write-Host "  Aldigim Degerlendirmeler bolumu"
Write-Host "  Musteri adi ve ilgili talep"
Write-Host "  Yildiz ve yorumlar"
Write-Host "  Puan ozeti"
Write-Host "  Teklif durumlari Turkcelestirildi"
Write-Host "  Turkce karakter bozulmalari temizlendi"
Write-Host ""
